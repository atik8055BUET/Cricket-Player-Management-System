...
public class SearchPlayerController implements Initializable {
    ...
    private void handleotherClub(ActionEvent event) {
        try {
            ...
            selectedOtherClub=club;
            if (club!=null && club.equals("My Club")) {
                isotherClub = false;
                try {
                    UpdateList();
    ...
    public void UpdateOtherListRecursive() throws ClassNotFoundException {
        try {
            ...
            if (response.equals("Change")) {
                ...
                if(!selectedOtherClub.equals("")){
                    Platform.runLater(() -> otherClub.setValue(selectedOtherClub));
                }
            }
            networkUtil.closeConnection();
        } catch (IOException e) {
    ...
    private void handleBackButtonAction(ActionEvent event) throws IOException {
        ...
        else if(logout.getValue().equals("Logout")){
            NetworkUtil networkUtil = new NetworkUtil("localhost", 12345);
